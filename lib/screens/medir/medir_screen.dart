  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text('Data de medição:',
              style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900)),
          const SizedBox(height: 8),
          _boxed(Row(children: [
            Expanded(
                child:
                    Text(_fmt(data), style: const TextStyle(fontSize: 18))),
            IconButton(
          ...
          _boxed(Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Última refeição (opcional):',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 6),
              Row(children: [
                Expanded(
                    child: Text(ultimaRefeicao == null
                        ? '—'
                        : _fmt(ultimaRefeicao!))),
                TextButton.icon(
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                await fs.medicoes(auth.user!.uid).add({
                  ...
                  'contexto': contexto,
                  'contextoOutro':
                      (contexto == 'Outro' ? outroCtrl.text.trim() : null),
