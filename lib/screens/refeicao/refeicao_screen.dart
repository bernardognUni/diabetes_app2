      ...
      child: Column(
        children: [
          ...
          _boxed(Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('Tipo de refeição:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
          ...
          _boxed(SizedBox(
            height: 140,
            child: TextField(controller: desc, maxLines: null, expands: true,
              decoration: const InputDecoration(border: InputBorder.none, hintText: 'Descrição do que comeu')),
          )),
          const SizedBox(height: 10),
          _boxed(Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('Opcional:', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20)),
            const SizedBox(height: 6),
            TextField(controller: carbs, keyboardType: TextInputType.number,
              decoration: const InputDecoration(border: InputBorder.none, hintText: 'Carboidratos (g): _____')),
          ])),
          ...
          _bigButton('Enviar', () async {
            ...
            desc.clear(); carbs.clear(); tipo=null; setState((){});
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Refeição salva!')));
          }),
          const SizedBox(height: 8),
        ],
      ),
